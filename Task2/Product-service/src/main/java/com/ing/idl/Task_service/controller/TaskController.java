...
import com.ing.idl.Task_service.entity.Ecategory;
...
public class TaskController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<Ecategory>>>getAllCategoryAvailable(){
        Ecategory[] theresponse= Ecategory.values();

                new ApiResponse<>(theresponse, "List of products", true);
                //i should return the theresponse list
        return null;
    }
